...
First, let's open [src/App.tsx](#src/App.tsx) and take a look inside:
...
After a few moments, you should see a new web window appear. It should look something like this:

![image](/lessonResources/image_2.png)
...
![image](/lessonResources/image.png)
...
![image](/lessonResources/image_3.png)
...
![image](/lessonResources/image_6.png)
...
![image](/lessonResources/image_8.png)
...
![image](/lessonResources/image_10.png)
...
![image](/lessonResources/image_7.png)
...
```jsx
<h1 className="text-4xl font-bold text-center mt-10">Hello, {person.name}!</h1>
```
...
![image](/lessonResources/image_9.png)
...
```jsx
<button className="mt-5 p-2 bg-blue-500 text-white rounded hover:bg-blue-700 transition duration-300">
  Click Me!
</button>
```
